...
const SignUp = () => {
  ...
  const handle_submit  = (e) => {e.preventDefault(); setsubmited(true);}

  const [submited, setsubmited] = useState(false);

  return (
    <div>
        <h1 className="alert text-center">SignUp</h1>
        ...
        <form className="form-control-sm d-flex flex-column align-items-center">
            ...
            <button onClick={handle_submit} className="w-25 btn btn-primary">SignUp</button>
        </form>
    </div>
  )
}
